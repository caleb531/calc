...
(b.factorial(a-c)*b.factorial(c))};b.perms=b.permute=function(a,c){function e(i){var j,l;if(i.length===c)h=b.map(i,function(b){return a[b]}),g.push(h);else{j=b.filtered(f,function(a){return-1===b.index(i,a)});for(l=0;l<j.length;l+=1)e(i.concat(j[l]))}}var f,g,h;g=[];c===m&&(c=a.length);a.split&&(a=a.split(""));f=b.map(a,function(a,b){return b});e([]);return g};b.degrees=function(a){return a*(180/r)};b.radians=function(a){return a*(r/180)};b.radiansf=function(a){a=b.frac(a/r);return 0!==a[0]%1&&1===
a[0]?a[0]+"\u03c0":a=a.join("/").replace(/^(-)?1$/gi,"$1\u03c0").replace(/\//gi,"\u03c0/").replace(/^(-)?1\u03c0/gi,"$1\u03c0").replace(/\/1$/gi,"").replace(/^0\u03c0/gi,"0")};b.sin=j.sin;b.cos=j.cos;b.tan=j.tan;b.csc=function(a){return 1/b.sin(a)};b.sec=function(a){return 1/b.cos(a)};b.cot=function(a){return 1/b.tan(a)};b.asin=j.asin;b.acos=j.acos;b.atan=j.atan;b.atan2=j.atan2;b.acsc=function(a){return b.asin(1/a)};b.asec=function(a){return b.acos(1/a)};b.acot=function(a){return b.atan(1/a)};b.acot2=
...
"")};b.commas=function(a){a=D(a).split(".");-1===a[0].indexOf("e")&&(a[0]=a[0].replace(/(\d)(?=(\d\d\d)+(?!\d))/g,"$1,"));return a.join(".")};b.noCommas=function(a){a=a.replace(/,/gi,"");return y(a)};b.isEven=function(a){return 0===a%2};b.isOdd=function(a){return 1===s(a)%2};b.isInteger=function(a){return 0===a%1};b.isPrime=function(a){return 2===b.factors(a).length};b.isComposite=function(a){a=s(a);return 2<b.factors(a).length};b.isFactor=b.isFactorOf=function(a,b){return 0===b%a};b.isFib=function(a){var b;
b=5*l(a,2)+4;a=0<a?5*l(a,2)-4:b;return 0===n(b)%1||0===n(a)%1?z:A};b.rand=b.random=function(a,b){a===m&&b===m?(a=0,b=1):b===m&&(b=a,a=0);return b.length?w(b.length*G()):a+(b-a)*G()};b.randInt=function(a,c){return u(b.rand(a,c))};b.scrambled=b.scramble=function(a){var c,e,a=a.slice(0);for(e=0;e<a.length;e+=1)c=a[e],a.splice(e,1),a.splice(b.random(a),0,c);return a};b.choices=function(a,c){return b.scramble(a).slice(0,c||1)};b.choice=function(a){return b.scramble(a)[0]};b.base=function(a,b){return a.toString(b)};
b.decimal=b.dec=function(a,b){return H(a,b)};b.binary=b.bin=function(a){return a.toString(2)};b.octal=b.oct=function(a){return a.toString(8)};b.hex=function(a){return a.toString(16)};b.not=function(a){return!a};b.and=function(a,b){return!!a&&!!b};b.or=function(a,b){return!!a||!!b};b.xor=function(a,b){return(!!a||!!b)&&a!==b};b.nand=function(a,b){return!(a&&b)};b.nor=function(a,b){return!(a||b)};b.matrix=function(a){return new B(a)};i=B.prototype;i.scale=function(a){var c=this.matrix.slice(0),e,f;
for(e=0;e<c.length;e+=1)for(f=0;f<c[e].length;f+=1)c[e][f]*=a;return b.matrix(c)};i.row=function(a){return this.matrix[a]};i.col=function(a){return E(this.matrix,a)};i.value=function(a){var b=this.matrix,e=o(b),f=x(a/e)-1;return b[f]?b[f][a%e]:m};i.index=function(a){var b=this.matrix,e=b.length,f=o(b),g,h;for(g=0;g<e;g+=1)for(h=0;h<f;h+=1)if(b[g][h]===a)return g*f+h;return p};i.nrows=i.rows=function(){return this.matrix.length};i.ncols=i.cols=function(){return o(this.matrix)};i.nvalues=i.values=function(){var a=
this.matrix;return a.length*o(a)};i.add=function(a){var c=this.matrix,e,f,g=[],a=b.matrix(a).matrix;if(c.length!==a.length||c[0].length!==a[0].length)return p;for(e=0;e<c.length;e+=1){g[e]=[];for(f=0;f<c[e].length;f+=1)g[e][f]=c[e][f]+a[e][f]}return b.matrix(g)};i.subtract=function(a){return this.add(b.matrix(a).scale(-1))};i.multiply=function(a){var a=b.matrix(a).matrix,c=this.matrix,e,f,g,h,i,j,l=c.length,n=a[0].length,m=[];if(c[0].length!==a.length)return p;for(e=0;e<l;e+=1){m[e]=[];for(f=0;f<
n;f+=1){h=0;i=c[e];j=E(a,f);for(g=0;g<i.length;g+=1)h+=i[g]*j[g];m[e][f]=h}}return b.matrix(m)};i.det=i.determinant=function(){var a=this.matrix,c=a.length,e=o(a);if(1===c&&1===e)a=a[0][0];else if(1<c&&1<e){var c=1,e=a[0],f=o(a),g,h=0,i;for(i=0;i<f;i+=1)g=F(a.slice(0),[0,i]),h+=e[i]*c*b.matrix(g).det(),c*=-1;a=h}else a=p;return a};i.transpose=i.reflect=function(){var a=this.matrix,c=a.length,e=o(a),f=[],g,h;for(h=0;h<e;h+=1){f[h]=[];for(g=0;g<c;g+=1)f[h][g]=a[g][h]}return b.matrix(f)};i.cofactors=
function(){var a=this.matrix,c=a.length,e=o(a),f=[],g=1,h,i,j,l,a=a.slice(0);for(j=0;j<c;j+=1){h=g;f[j]=[];for(l=0;l<e;l+=1)i=F(a,[j,l]),f[j].push(b.matrix(i).det()*h),h*=-1;g*=-1}return b.matrix(f)};i.adjugate=i.adj=function(){return this.transpose().cofactors()};i.inverse=i.inv=function(){var a=this.matrix,c=a.length,e=o(a),f=this.det(),g;if(1===c&&1===e)g=[[1/a[0][0]]];else if(1<c&&1<e)if(f)g=this.adjugate().scale(1/f);else return p;return b.matrix(g)};i.identity=i.iden=function(){var a=o(this.matrix),
c=[],e,f,g=0,h;for(e=0;e<a;e+=1){c[e]=[];for(f=0;f<a;f+=1)h=f===g?1:0,c[e][f]=h;g+=1}return b.matrix(c)};b.vector=function(a){return new C(a)};i=C.prototype;i.mag=function(){var a=this.vector;return n(l(a[0],2)+l(a[1],2)+l(a[2],2))};i.angle=function(){return b.polar(this.vector)[1]};i.scale=function(a){var c=this.vector.slice(0);c[0]*=a;c[1]*=a;c[2]*=a;return b.vector(c)};i.add=function(a){var c=this.vector,a=b.vector(a).vector;return b.vector([c[0]+a[0],c[1]+a[1],c[2]+a[2]])};i.subtract=function(a){return this.add(b.vector(a).scale(-1))};
i.dot=function(a){var c=this.vector,a=b.vector(a).vector;return c[0]*a[0]+c[1]*a[1]};i.cross=function(a){var c=this.vector,a=b.vector(a).vector;return 0===c[2]||0===a[2]?p:b.vector([c[1]*a[2]-c[2]*a[1],c[2]*a[0]-c[0]*a[2],c[0]*a[1]-c[1]*a[0]])}})(self,Math,parseFloat,parseInt,String,!0,!1,null);
